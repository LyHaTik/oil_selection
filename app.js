...
const carData = {
	"Acura": {
	    ...
	    "RDX": {
		"1 поколение, вкл.рестайлинг (TB1/TB2) 2006-2012": ["2.3 Turbo + SH-AWD (K23A1)"],
		"2 поколение, вкл. рестайлинг (TB3/TB4) 2012 - Н.В.": ["3.5 AWD (J35Z2)"]
	    },
	    "TLX": {
		"1 поколение (2014-2016)": ["2.4 (K24W7)", "3.5 AWD (J35Y6)"]
	    },
	    "ZDX": {"1 поколение (YB1) 2009-2013": ["3.7 AWD (J37A5)"]}
        },
        "Audi": {
            "A1 (8X)": {},
	    "A2 (8Z)": {},
